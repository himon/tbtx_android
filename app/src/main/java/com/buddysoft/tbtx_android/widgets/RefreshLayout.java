...
public class RefreshLayout extends SwipeRefreshLayout implements
    ...
    public boolean isOpenDown = true;

    public boolean getIsOpenDown() {
        return isOpenDown;
    }

    public void setIsOpenDown(boolean isOpenDown) {
        this.isOpenDown = isOpenDown;
    }
    ...
    public RefreshLayout(Context context, AttributeSet attrs) {
        ...
        // getScaledTouchSlop() 触发移动事件的最小距离
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();

        mListViewFooter = LayoutInflater.from(context).inflate(
                R.layout.listview_footer, null, false);
        setColorSchemeResources(R.color.red1, R.color.blue2, R.color.font_hui,
                R.color.green);
